...
\begin{center}
{\LARGE \textbf{PETU Strong Predictions and Preregistered Tests}}\\[0.4em]
{\large Formal prediction classes, null models, thresholds and domain templates}\\[0.7em]
...
\section{General preregistration principle}
...
\section{Required model hierarchy}
...
\section{Prediction classes}

\subsection{P1. Coherence reconstruction}
...
\subsection{P2. Unity reconstruction}
...
\subsection{P3. Irreducible triadic gain}
...
\subsection{P4. Linkage emergence from structured support}
...
\subsection{P5. Perturbative coherence loss}
...
\subsection{P6. Fragility from disproportion}
...
\subsection{P7. Natural-versus-perturbed discrimination}
...
\subsection{P8. Multi-scale stability}
...
\subsection{P9. External endpoint validity}
...
\subsection{P10. Alternative operationalization robustness}
...
\subsection{P11. Adversarial null resistance}
...
\subsection{P12. Dynamic change prediction}
...
\section{Domain preregistration template}
...
\section{Domain-specific prediction map}

\begin{longtable}{p{0.18\linewidth}p{0.72\linewidth}}
\toprule
\textbf{Domain} & \textbf{Preregistered prediction focus}\\
\midrule
...
\section{Cross-domain convergence test}
...
\section{Minimal valid preregistered test}
...
\section{Strong preregistered test}
